...
public class UserServiceTest {
    ...
    public void testUpdateUserRole_Success() {
        ...
        // 验证结果
        assertTrue(result);
        assertEquals("INTERNAL_STAFF", yonghuEntity.getUserRole());
    ...
    public void testIsValidRole_ValidRoles() {
        ...
        assertFalse(userService.isValidRole("PLATFORM_ADMIN"));
    }
    ...
    public void testGetUserInfo_AllRoleTypes() {
        ...
        // 历史 PLATFORM_ADMIN 映射为 INTERNAL_STAFF
        testRoleConversion(userId, "PLATFORM_ADMIN", UserRole.INTERNAL_STAFF, "内部员工");
