	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="出库数量" prop="fuzhuangkucun" >
					<el-input v-model.number="ruleForm.fuzhuangkucun" placeholder="出库数量" clearable  :readonly="ro.fuzhuangkucun"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="出库数量" prop="fuzhuangkucun" >
					<el-input v-model="ruleForm.fuzhuangkucun" placeholder="出库数量" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-else-if="ruleForm.jiaohuoshijian" label="交货时间" prop="jiaohuoshijian" >
					<el-input v-model="ruleForm.jiaohuoshijian" placeholder="交货时间" readonly></el-input>
				</el-form-item>
...
<script>
	...
	export default {
		...
		created() {
			this.ruleForm.jiaohuoshijian = this.getCurDate()
		},
		methods: {
			// 下载
			download(file){
