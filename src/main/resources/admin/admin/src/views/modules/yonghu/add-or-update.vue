	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="select" v-if="type!='info'" label="用户角色" prop="userRole">
					<el-select v-model="ruleForm.userRole" placeholder="请选择用户角色" clearable>
						<el-option label="经销商" value="DEALER"></el-option>
						<el-option label="内部员工" value="INTERNAL_STAFF"></el-option>
						<el-option label="仓库管理员" value="WAREHOUSE_ADMIN"></el-option>
					</el-select>
				</el-form-item>
				<el-form-item v-else class="input" label="用户角色" prop="userRole">
					<el-input :value="roleLabel(ruleForm.userRole)" placeholder="用户角色" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="电子邮件" prop="dianziyoujian" >
					<el-input v-model="ruleForm.dianziyoujian" placeholder="电子邮件" clearable  :readonly="ro.dianziyoujian"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="电子邮件" prop="dianziyoujian" >
					<el-input v-model="ruleForm.dianziyoujian" placeholder="电子邮件" readonly></el-input>
				</el-form-item>
			</template>
