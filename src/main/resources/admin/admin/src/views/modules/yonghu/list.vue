			...
			<el-form class="center-form-pv" :style='{"margin":"0 10px 20px"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"10px","background":"#fff","display":"flex"}' >
					<div :style='{"alignItems":"center","margin":"0 10px 0 0","display":"flex"}'>
						...
						<el-input v-model="searchForm.yonghuzhanghao" placeholder="账号" @keydown.enter.native="search()" clearable></el-input>
					</div>
					<div :style='{"alignItems":"center","margin":"0 10px 0 0","display":"flex"}'>
						...
						<el-input v-model="searchForm.yonghuxingming" placeholder="姓名" @keydown.enter.native="search()" clearable></el-input>
					</div>
			...
			<div :style='{"width":"100%","padding":"0 10px","fontSize":"14px","color":"#000"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='true'  
						...
						width="120">
						<template slot-scope="scope">
							{{ {DEALER:'经销商',INTERNAL_STAFF:'内部员工',WAREHOUSE_ADMIN:'仓库管理员'}[scope.row.userRole] || scope.row.userRole || '未设置' }}
						</template>
					</el-table-column>
					<el-table-column :resizable='true' :sortable='true'  
						prop="dianziyoujian"
